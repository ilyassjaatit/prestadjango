"""
Django settings for prestadjango project.
"""
import os
...
SECRET_KEY = "django-insecure-&97y!jv@ewly+)3apo40cac(@sp8zav**3o-h%1ej=7uku*p5#"
...
DATABASES = {
    "default": {
        ...
        "NAME": env("POSTGRES_DB", default="postgresql_db"),
        "USER": env("POSTGRES_USER", default="postgresql_user"),
